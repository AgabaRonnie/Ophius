...
// laravel example
    ...
    Route::get('/create_member', [\App\Http\Controllers\MemberController::class, 'create']);
    Route::post('/store_member', [\App\Http\Controllers\MemberController::class, 'store']);
    Route::get('/edit_member/{id}', [\App\Http\Controllers\MemberController::class, 'edit']);
    //show member
    Route::get('/show_member/{id}', [\App\Http\Controllers\MemberController::class, 'show']);

    Route::post('/member/update/{id}', [\App\Http\Controllers\MemberController::class, 'update']);
    Route::post('/delete_member', [\App\Http\Controllers\MemberController::class, 'destroy']);
    Route::resource('members', \App\Http\Controllers\MemberController::class);


     Route::get('/create_event', [\App\Http\Controllers\EventController::class, 'create']);
    Route::post('/store_event', [\App\Http\Controllers\EventController::class, 'store']);
    Route::get('/edit_event/{id}', [\App\Http\Controllers\EventController::class, 'edit']);
    Route::get('/show_event/{id}', [\App\Http\Controllers\EventController::class, 'show']);
    Route::post('/event/update/{id}', [\App\Http\Controllers\EventController::class, 'update']);
    Route::post('/delete_event', [\App\Http\Controllers\EventController::class, 'destroy']);
    Route::resource('events', \App\Http\Controllers\EventController::class);



    Route::resource('event_galleries', \App\Http\Controllers\EventGalleryController::class);
    Route::get('/create_event_gallery', [\App\Http\Controllers\EventGalleryController::class, 'create']);
    Route::post('/store_event_gallery', [\App\Http\Controllers\EventGalleryController::class, 'store']);
    Route::get('/edit_event_gallery/{id}', [\App\Http\Controllers\EventGalleryController::class, 'edit']);
    Route::post('/event_gallery/update/{id}', [\App\Http\Controllers\EventGalleryController::class, 'update']);
    Route::post('/delete_event_gallery', [\App\Http\Controllers\EventGalleryController::class, 'destroy']);

  //clubs
    Route::resource('clubs', \App\Http\Controllers\ClubController::class);
    Route::get('/create_club', [\App\Http\Controllers\ClubController::class, 'create']);
    Route::post('/store_club', [\App\Http\Controllers\ClubController::class, 'store']);
    Route::get('/edit_club/{id}', [\App\Http\Controllers\ClubController::class, 'edit']);
    Route::get('/show_club/{id}', [\App\Http\Controllers\ClubController::class, 'show']);
    Route::post('/club/update/{id}', [\App\Http\Controllers\ClubController::class, 'update']);
    Route::post('/delete_club', [\App\Http\Controllers\ClubController::class, 'destroy']);



    Route::resource('sessions', \App\Http\Controllers\SessionController::class);
Route::get('/create_session', [\App\Http\Controllers\SessionController::class, 'create']);
Route::post('/store_session', [\App\Http\Controllers\SessionController::class, 'store']);
Route::get('/edit_session/{id}', [\App\Http\Controllers\SessionController::class, 'edit']);
Route::post('/session/update/{id}', [\App\Http\Controllers\SessionController::class, 'update']);
Route::post('/delete_session', [\App\Http\Controllers\SessionController::class, 'destroy']);
